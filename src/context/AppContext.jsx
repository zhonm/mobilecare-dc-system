  ...
  return (
    <AppContext.Provider
      value={{
        ...
        loadArchivedIntakes: intakeRecords.loadArchivedIntakes,
        isLoadingArchivedIntakes: intakeRecords.isLoadingArchivedIntakes,
        isIntakeRecordArchived: intakeRecords.isIntakeRecordArchived,
        ...
        updateShipmentStatus: shipmentsDomain.updateShipmentStatus,
        confirmSiteReceive: shipmentsDomain.confirmSiteReceive,
        loadArchivedShipments: shipmentsDomain.loadArchivedShipments,
        isLoadingArchivedShipments: shipmentsDomain.isLoadingArchivedShipments,
        isShipmentArchived: shipmentsDomain.isShipmentArchived,
        ...
        fetchArchivedShipmentsFromCloud: cloudSync.fetchArchivedShipmentsFromCloud,
        fetchArchivedIntakesFromCloud: cloudSync.fetchArchivedIntakesFromCloud,
